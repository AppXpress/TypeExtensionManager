...
import { fetchDocument, queryDocument, setupSeedFile } from '../customerUtility';
const {
    rl,
    ...
    fields:{CUSTOMER, RULE_SET_TYPE, OBJECT_FIELDS, PO_NUMBERS_LIST,CUSTOMER_NAME, QUERIED_OBJECTS, FETCHED_OBJECTS, DOCUMENT_TYPE, DOC_SHORT_FORM, FILE, CUSTOMER_DIRECTORY, CUSTOMER_TEST_DIRECTORY, ENVIRONMENT, HTTP_HEADER, USER, AUTHORIZATION, DATA_KEY, SAMPLE_REF_NUMBER, QUERY_URL, FETCH_URL, IS_SAMPLE_REQUIRED, ORDERS_FIELD},
    ...
    GENERAL:{AFFIRM, NEGATIVE, GET, POST, SEED},
